...
module "withdrawal-devnet-0_bootnode" {
  ...
  tags = concat(local.shared_project_tags,["beacon","validator","teku","execution","geth","explorer","bootnode","faucet", "ethstats_server","landing_page","reverse_proxy","withdrawal-devnet-0"])

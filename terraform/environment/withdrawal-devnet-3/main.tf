...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/withdrawal-devnet-3/terraform.tfstate"
  }
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../../withdrawal-devnet-3/inventory/inventory.ini"
}
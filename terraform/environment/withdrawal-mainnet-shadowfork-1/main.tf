...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/withdrawal-mainnet-shadowfork-1/terraform.tfstate"
  }
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
...
variable "ethereum_network" {
  type = string
  default = "withdrawal-mainnet-shadowfork-1"
}
...
variable "digitalocean_vpcs" {
  ...
  default = {
    "ams3" = {
      name = "withdrawal-mainnet-shadowfork-1-ams"
      ip_range = "10.100.75.0/24"
    },
    "nyc3" = {
      name = "withdrawal-mainnet-shadowfork-1-nyc3"
    ...
    "blr1" = {
      name = "withdrawal-mainnet-shadowfork-1-blr1"

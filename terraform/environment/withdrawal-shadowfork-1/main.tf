...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/withdrawal-shadowfork-1/terraform.tfstate"
  }
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
...
variable "ethereum_network" {
  type = string
  default = "withdrawal-shadowfork-1"
}
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../../withdrawal-shadowfork-1/inventory/inventory.ini"
}